    ...
    for cond in conds:
        ...
        for k in [8]:
            ...
            for add in [0,500,1000,5000]:
                ...
                pred=knn_predict(val, vl, bank_feats_raw, bank_labels, k=1, device=device)
        ...
        # predict for extra
        extra_pred=knn_predict(pool[extra], pl[extra], bank_feats_raw, bank_labels, k=1, device=device)
