...
def main():
    ...
    print("  All ~1 = the top eigenspaces of S_c and S_t coincide (the rotation, if")
    print("  any, is WITHIN the same subspace). Decaying = the corruption adds NEW")
    print("  directions a rotation alone cannot span; CORAL's eigenvalue")
