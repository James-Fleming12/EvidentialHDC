...
uv run ablation_kitti-c.py --ablations methods --seeds $SEEDS --chunked --skip_done | tee logs/m_series_methods.log
...
uv run ablation_kitti-c.py --ablations prior --seeds $SEEDS --chunked --skip_done | tee logs/m_d_prior_only.log
